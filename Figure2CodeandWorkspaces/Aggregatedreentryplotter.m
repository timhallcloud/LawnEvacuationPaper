figure;
bar([1 2 3 4 5 6]-0.25,[mean(NoNPR4) mean(NoSAMS5) mean(NoAIY) mean(NoDOP2) mean(NoMPZ1) mean(NoFLP4)],0.2,'b')
hold on
bar([1 2 3 4 5 6]+0.25,[mean(ATRNPR4) mean(ATRSAMS5) mean(ATRAIY) mean(ATRDOP2) mean(ATRMPZ1) mean(ATRFLP4)],0.2,'r')
errorbar([1 2 3 4 5 6]-0.25,[mean(NoNPR4) mean(NoSAMS5) mean(NoAIY) mean(NoDOP2) mean(NoMPZ1) mean(NoFLP4)],[std(NoNPR4)/sqrt(length(NoNPR4)) std(NoSAMS5)/sqrt(length(NoSAMS5)) std(NoAIY)/sqrt(length(NoAIY)) std(NoDOP2)/sqrt(length(NoDOP2)) std(NoMPZ1)/sqrt(length(NoMPZ1)) std(NoFLP4)/sqrt(length(NoFLP4))],'.k')
errorbar([1 2 3 4 5 6]+0.25,[mean(ATRNPR4) mean(ATRSAMS5) mean(ATRAIY) mean(ATRDOP2) mean(ATRMPZ1) mean(ATRFLP4)],[std(ATRNPR4)/sqrt(length(ATRNPR4)) std(ATRSAMS5)/sqrt(length(ATRSAMS5)) std(ATRAIY)/sqrt(length(ATRAIY)) std(ATRDOP2)/sqrt(length(ATRDOP2)) std(ATRMPZ1)/sqrt(length(ATRMPZ1)) std(ATRFLP4)/sqrt(length(ATRFLP4))],'.k')
xticks([1:6])
xticklabels({'npr-4','sams-5','ttx-3','dop-2','mpz1','flp4'})

scatter((1-0.15)*ones(1,length(NoNPR4)),NoNPR4,'.k')
scatter((1+0.15)*ones(1,length(ATRNPR4)),ATRNPR4,'.k')
scatter((2-0.15)*ones(1,length(NoSAMS5)),NoSAMS5,'.k')
scatter((2+0.15)*ones(1,length(ATRSAMS5)),ATRSAMS5,'.k')
scatter((3-0.15)*ones(1,length(NoAIY)),NoAIY,'.k')
scatter((3+0.15)*ones(1,length(ATRAIY)),ATRAIY,'.k')
scatter((4-0.15)*ones(1,length(NoDOP2)),NoDOP2,'.k')
scatter((4+0.15)*ones(1,length(ATRDOP2)),ATRDOP2,'.k')
scatter((5-0.15)*ones(1,length(NoMPZ1)),NoMPZ1,'.k')
scatter((5+0.15)*ones(1,length(ATRMPZ1)),ATRMPZ1,'.k')
scatter((6-0.15)*ones(1,length(NoFLP4)),NoFLP4,'.k')
scatter((6+0.15)*ones(1,length(ATRFLP4)),ATRFLP4,'.k')
